    ...
    <div className="py-5">
      <form onSubmit={handleSubmit} className="flex flex-col gap-5 justify-center content-center w-full">
        ...
        <div className="mx-auto">
          {/* submit button */}
          <button disabled={loading} type='submit' className="flex items-center justify-center gap-2 p-2 border-2 w-fit border-slateBlue text-slateBlue rounded-lg transition-all duration-300 ease-in-out hover:bg-slateBlue hover:text-creamyWhite dark:text-creamyWhite dark:border-creamyWhite dark:hover:bg-creamyWhite dark:hover:text-slateBlue hover:bg-gradient-to-r from-slateBlue dark:hover:bg-gradient-to-r dark:from-creamyWhite  hover:border-slateBlue select-none">
            {loading ?  (
              <>
                {sendSuc ? (<span className=' text-center text-steelBlueGray'>Success！</span>) : (
                <>
                  ...
                  <span className="text-steelBlueGray  animate-pulse">Sending...</span>
                </>)}
              </>
            ):(
            <>
